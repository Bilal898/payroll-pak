...
class TaxSlabs2019(models.Model):
    slab = models.DecimalField(default=0, max_digits=9, decimal_places=2)
    slab_basic_deduction = models.IntegerField(default=0, null=True)
    slab_percentage_deduction = models.IntegerField(default=0, null=True)
